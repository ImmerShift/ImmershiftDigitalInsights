    ...
    <div className="bg-white rounded-2xl border border-[#EAE3D9] overflow-hidden shadow-sm">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse min-w-[800px]">
          <thead>
            <tr>
              <th scope="col" className="bg-[#FDF8F3] px-6 py-4 text-xs font-bold text-[#856B66] uppercase tracking-wider">Channel</th>
              <th scope="col" className="bg-[#FDF8F3] px-6 py-4 text-xs font-bold text-[#856B66] uppercase tracking-wider text-right">{labels.metric1}</th>
              <th scope="col" className="bg-[#FDF8F3] px-6 py-4 text-xs font-bold text-[#856B66] uppercase tracking-wider text-right">{labels.metric2}</th>
              <th scope="col" className="bg-[#FDF8F3] px-6 py-4 text-xs font-bold text-[#856B66] uppercase tracking-wider text-right">{labels.efficiency}</th>
              <th scope="col" className="bg-[#FDF8F3] px-6 py-4 text-xs font-bold text-[#856B66] uppercase tracking-wider w-64">Distribution</th>
            </tr>
          </thead>
